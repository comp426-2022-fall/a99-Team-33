...
export function globalAll() {
    ...
    return COVID_API.all();
}

export function globalYesterdayAll() {
    /**
     * Grab all yesterday covid global data.
     * return: Promise
     */

    return COVID_API.yesterday.all()
}

export function countryCovidData(country) {
    /**
     * Grab covid data for a given country
     * return: Promise
     */

    return COVID_API.countries({country: country});
}

export function countryYesterdayCovidData(country) {
    /**
     * Grab yesterday covid data for a given country
     * return: Promise
     */

    return COVID_API.yesterday.countries({country: country});
}

export function statesCovidData(state) {
    /**
     * Grab covid data for a given state in United States
     * return: Promise
     */

    return COVID_API.states({state: state})
}

export function statesYesterdayCovidData(state) {
    /**
    ...
    return COVID_API.yesterday.states({state:state})
}

export function globalHistorical(pastDays) {
    /**
     * Grab all historical global data
     * return: Promise
     */

    return COVID_API.historical.all({days: pastDays});
}

export function countryHistorical(country, pastDays) {
    /**
     * Grab all historical specified country data
     * return: Promise
     */

    return COVID_API.historical.countries({country: country, days: pastDays});
}
